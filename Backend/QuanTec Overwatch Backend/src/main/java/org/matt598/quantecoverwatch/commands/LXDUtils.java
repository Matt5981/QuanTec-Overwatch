...
public class LXDUtils {
    private static final String LIST_CMD = "sudo -u matt598 /home/matt598/lxdwrap foo list bar.service";
    ...
    private static String assembleStatusCMD(String containerName, String method, String serviceName){
        ...
        return "sudo -u matt598 /home/matt598/lxdwrap "+containerName+" "+method+" "+serviceName+".service";
    }
