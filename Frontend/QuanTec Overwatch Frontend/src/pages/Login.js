      ...
      <div className="container">
        <div className={this.state.killScreen ? 'App disabled' : "App"}>
          ...
          <button className='discordOAuthLaunch' onClick={() => {
            ...
            // FIXME change back!
            window.location.href = 'https://discord.com/oauth2/authorize?response_type=code&client_id=1075308298049437726&scope=identify%20guilds&state=' + id + '&redirect_uri=https%3A%2F%2Fthegaff.dev&prompt=none'; // '&redirect_uri=https%3A%2F%2Fthegaff.dev&prompt=consent'
            }}>
              {
